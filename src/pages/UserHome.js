...
const UserHome = () => {
  ...
  return (
    <div className="relative bg-dwhite w-full h-[1024px] overflow-hidden text-left text-17xl text-black font-poppins">
      ...
      <div className="absolute top-[521px] left-[0px] w-[266px] overflow-hidden flex flex-col items-end justify-center">
      ...
      <img
        ...
        src="/frame.svg"
      />
      <div className="absolute top-[219px] left-[0px] w-[1354px] overflow-hidden flex flex-col items-end justify-center">
      ...
      <div className="absolute top-[0px] left-[0px] w-[1444px] h-[83px] overflow-hidden flex flex-col items-start justify-end text-16xl text-dwhite font-inter">
        <div className="relative w-[361px] h-[140px]" />
        <div className="relative bg-gray-400 w-[1440px] h-20 mt-[-117px]">
          <div className="absolute top-[calc(50%_-_41px)] left-[calc(50%_-_720px)] w-[248px] h-[73px] flex flex-row pt-[7px] px-0 pb-[3px] box-border items-center justify-between">
            <img

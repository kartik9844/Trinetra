const CardContainer = () => {
  return (
    <section className="self-stretch bg-dwhite h-[570px] overflow-hidden shrink-0 flex flex-row py-[60px] px-[170px] box-border items-center justify-center relative gap-[60px] text-left text-21xl text-black font-normal font-popins">
      <div className="flex-1 flex flex-col items-start justify-start gap-[24px] z-[0]">
        <h1 className="m-0 self-stretch relative text-inherit leading-[48px] font-normal font-popins">
          3D Lab
        </h1>

const Container = () => {
  return (
    <div className="w-[574.37px] h-[258.52px] overflow-hidden shrink-0 flex flex-col pt-0 px-0 pb-[0.00000762939453125px] box-border items-center justify-start gap-[19px] text-left text-17xl text-dwhite font-popins">
